...
function GolemLogo({ size = 28, className = "" }: { size?: number; className?: string }) {
  return (
    ...
    <div className="bg-w-bg-secondary border-b border-w-border">
      <div className="mx-auto flex max-w-7xl items-center justify-center gap-3 px-4 py-2.5">
        <span className="text-[13px] text-w-text">
          <span className="font-semibold text-white">Golem AI</span>
    ...
    <header className={cx(
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })} className="flex items-center gap-2.5">
          <GolemLogo />
          <span className="text-[17px] font-semibold tracking-tight text-w-cream">GolemAI</span>
        </button>
...
function RotatingPills({ reducedMotion }: { reducedMotion: boolean }) {
  const items = ["Federated Live Learning", "Multi-Agent System", "Accountable AI", "Proprietary Intelligence"];
...
function HeroTerminal({ reducedMotion }: { reducedMotion: boolean }) {
  const exchanges = useMemo(
    () => [
      { q: "Hey Golem, what's happening in the enterprise right now?", a: "12 agents active. Revenue anomaly in APAC — up 14%. 3 proprietary agents flagging competitor pricing movement." },
      ...
      { q: "Which agents should I deploy for Q4 planning?", a: "Recommending 4 analytics agents + 2 proprietary agents. Federated models updated with latest enterprise data." },
    ],
    []
  );
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-6 pb-24 pt-20 sm:pt-28">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          A multi-agent enterprise platform with real-time federated learning, a Seed to Sale (S2S)
          intelligence layer, and proprietary proprietary agents that give your enterprise the edge.
        </motion.p>
        ...
        >
          ...
          <div className="flex items-center gap-2 rounded-lg border border-w-border bg-w-bg-secondary px-4 py-2.5 font-mono text-[13px]">
            ...
            <span className="text-w-text">golem init --enterprise</span>
          </div>
        </motion.div>
      ...
      <div className="grid items-center gap-16 lg:grid-cols-2">
        ...
        >
          ...
          <p className="mt-4 text-[16px] leading-relaxed text-w-text">
            Golem isn&apos;t another dashboard. It&apos;s a living, learning intelligence layer that
          ...
          <div className="mt-10 flex items-stretch gap-3">
            ...
            <div className="flex-1 rounded-lg border border-white/25 bg-white/[0.06] p-4">
              <p className="mb-3 text-[10px] font-semibold uppercase tracking-wider text-white">With Golem</p>
              <div className="space-y-2">
                {["Seed to Sale (S2S)", "Federated Live Learning", "Proprietary Agents"].map((t) => (
        ...
        >
          {[
            ...
            { icon: BarChart3, title: "Siloed Data → Unified Intelligence", desc: "Every system, every signal, unified into one operational brain. Golem connects your enterprise end-to-end." },
  ...
  const products = [
    {
      ...
      icon: TrendingUp,
      desc: "A full-cycle revenue intelligence layer from seed-stage prospecting through to closed sale. Golem tracks deal flow, surfaces pipeline signals, and briefs your team on what moves the needle.",
  ...
  return (
    <section id="products" className="mx-auto max-w-7xl px-6 py-28">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-[16px] leading-relaxed text-w-text">
          From voice to agents to learning, Golem orchestrates intelligence
  ...
  return (
    <motion.svg viewBox="0 0 640 240" fill="none" className="h-full w-full"
      ...
      <text x={CX} y={CY + 1} textAnchor="middle" dominantBaseline="middle"
        fill="rgba(255,255,255,0.95)" fontSize="12" fontFamily="ui-sans-serif,sans-serif" fontWeight="700">GOLEM</text>
      {/* Source nodes — left */}
      {left.map((n, i) => (
  ...
  const steps = [
    {
      ...
      desc: "Golem maps your entire enterprise into a live operational graph. Every data source — ERP, CRM, comms, transactions — becomes part of the continuous learning loop.",
      icon: Link2,
      tags: ["APIs", "SaaS", "Data Warehouses", "Comms"],
    },
    {
      num: "2",
      title: "Golem learns, live",
      headline: "Federated models continuously ingest and learn from your data.",
      desc: "Unlike static AI, Golem\'s federated models update in real time without centralizing sensitive data. Your data stays in your systems — only learning signals are shared. The more you use it, the smarter it gets.",
      icon: Cpu,
    ...
    },
    {
      ...
      headline: "proprietary agents farm intel. Action agents execute. Everything is logged.",
      desc: "Proprietary agents run continuously across your stack — surfacing insights, flagging risks, and executing approved actions with full immutable audit trails and rollback support.",
      icon: Shield,
      tags: ["Proprietary Agents", "Audit Trail", "Accountable AI"],
    },
  ];
  ...
  return (
    <section id="how" className="mx-auto max-w-7xl px-6 py-28">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-[16px] leading-relaxed text-w-text">
          Connect your enterprise, Golem learns in real time, proprietary agents go to work.
        </p>
      </div>
      ...
      >
        <div className="relative overflow-hidden rounded-xl border border-w-border bg-w-bg-secondary p-10 sm:p-12">
          ...
          <div className="relative">
            ...
            &ldquo;Golem doesn&apos;t just surface data — it understands our enterprise. The proprietary agents
...
function LifecycleSection({ reducedMotion }: { reducedMotion: boolean }) {
  ...
  const tabs = [
    ...
    { label: "Intelligence", icon: Eye,
      heading: "Proprietary Intelligence Agents",
      desc: "Proprietary agents that continuously farm intel from your enterprise ecosystem to give you the edge.",
      features: [
...
function Footer() {
  const columns = [
    { title: "Platform", links: ["Seed to Sale (S2S)", "Multi-Agent Backend", "Analytics Engine", "Proprietary Agents"] },
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr_1fr]">
          <div>
            <div className="flex items-center gap-2.5">
              <GolemLogo />
              <span className="text-[17px] font-semibold text-w-cream">GolemAI</span>
            </div>
            <p className="mt-3 max-w-xs text-[13px] leading-relaxed text-w-muted">
              Generative Operational Logistics × Enterprise Management. A multi-agent
              platform powered by Federated Live Learning and Accountable AI.
            </p>
          </div>
          {columns.map((col) => (
            <div key={col.title}>
